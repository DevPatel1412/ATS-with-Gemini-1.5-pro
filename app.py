...
if submit1:
    ...
    if job_match_value < 60:
        lottie_path = r"D:\Inkey\SSIS\Azure AI\Resume Checker Thrugh the Generative AI\animation files\crying.json"
    elif 60 <= job_match_value < 70:
        lottie_path = r"D:\Inkey\SSIS\Azure AI\Resume Checker Thrugh the Generative AI\animation files\neutral.json"
    elif 70 <= job_match_value < 80:
        lottie_path = r"D:\Inkey\SSIS\Azure AI\Resume Checker Thrugh the Generative AI\animation files\happy.json"
    else:  # 80 and above
        lottie_path = r"D:\Inkey\SSIS\Azure AI\Resume Checker Thrugh the Generative AI\animation files\awesome.json"
